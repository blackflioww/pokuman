        ...
        private void Update() {
            ...
            if(fillDownSpeed){
                ...
                if(speedImage.GetComponent<Image>().fillAmount<0.01){
                    ...
                    GameObject.Find("CMVir").GetComponent<CinemachineVirtualCamera>().m_Lens.OrthographicSize = 7.3f;
                }
            }
        }
        ...
        public void keyController(){
            ...
            if(Input.GetKeyDown(KeyCode.H)){
                if(haveSpeedPower){
                    ...
                    GameObject.Find("CMVir").GetComponent<CinemachineVirtualCamera>().m_Lens.OrthographicSize = 9;
                }
            }
