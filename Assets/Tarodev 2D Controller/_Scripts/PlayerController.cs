...
namespace TarodevController {
    ...
    public class PlayerController : MonoBehaviour, IPlayerController {
        ...
        [Header("WALKING")] [SerializeField] public static float _acceleration = 90;
        [SerializeField] public static float _moveClamp = 13;
        [SerializeField] public static float _deAcceleration = 60f;
        ...
        [Header("JUMPING")] [SerializeField] public static float _jumpHeight = 30;
